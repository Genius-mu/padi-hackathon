        ...
        <motion.div className="max-w-5xl mx-auto text-center text-white">
          ...
          <motion.div className="flex flex-col sm:flex-row gap-8 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-9 py-7 text-[16px] sm:px-16 sm:py-8 sm:text-xl font-bold bg-white text-green-700 rounded-full shadow-2xl"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              className="px-6 sm:px-12 py-7 text-[16px] sm:text-xl font-bold border-4 border-white rounded-full hover:bg-white hover:text-green-700 transition-all"
            >
